package edu.exercicios.interfacespoo.alocacaoveiculoseminterface.app;

import java.time.LocalDateTime;
import java.time.format.DateTimeFormatter;
import java.util.Scanner;

import edu.exercicios.interfacespoo.alocacaoveiculoseminterface.model.Veiculo;
import edu.exercicios.interfacespoo.alocacaoveiculoseminterface.model.VeiculoAluguel;
import edu.exercicios.interfacespoo.alocacaoveiculoseminterface.services.AluguelService;
import edu.exercicios.interfacespoo.alocacaoveiculoseminterface.services.BrasilTaxaService;
